 ...
 *
 * Covers the functionalities used in start_stream_eigerclient:
 ...
 *
 * API base paths follow the session format (e.g. /detector/api/1.6.0/...).
 */
...
/*
 * GET /detector/api/1.6.0/status/{path}
