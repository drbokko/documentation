/*
 * stream2_buffer_decode.c - Buffer images and report compression statistics
 *
 * Like stream2_buffer, but also decompresses image data and reports
 * compression statistics (ratio, compressed vs decompressed bytes).
 * Does NOT save files.
 */
